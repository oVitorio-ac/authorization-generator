...
def processar_formulario_saida():
    ...
    pdf_buffer = criar_autorizacao_desbravadores(
        dados_formatados["nome_responsavel"],
        dados_formatados["cpf_responsavel"],
        dados_formatados["rg_responsavel"],
        endereco,
        dados_formatados["telefone_responsavel"],
        dados_formatados["nome_menor"],
        dados_formatados["rg_menor"],
        dados_formatados["cpf_menor"],
    )
    corpo = f"""
...
"""
    enviar_email(
        dados_formatados["email_responsavel"],
        f'autorização de saida para o {dados_formatados["nome_menor"]}',
        corpo,
        pdf_buffer,
    )
